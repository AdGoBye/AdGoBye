...
public static class SingleInstance
{
    ...
    public static bool Attach(bool noAutoExit)
    {
        lock (_syncRoot)
        {
            ...
            try
            {
                ...
                _logger.Verbose("Mutex name: {mutexName}", mutexName);
    ...
    private static void Run()
    {
        ...
        while (_mtxFirstInstance != null)
        {
            try
            {
                ...
                {
                    _logger.Warning("Another instance attempted to start: {instanceInformation}",
    ...
    [Serializable]
    private sealed record InstanceInformation
    {
        // just a storage
        [JsonInclude] public required string CommandLine;

        [JsonInclude] public required string[] CommandLineArgs;

        [JsonInclude] public required int ProcessId;
    }
}